...
class ModalEditUser extends Component {
    ...
    checkValidInput = () =>{//hàm kiểm tra có nhập hết giá trị chưa
        ...
        let arrInput = ['firstName', 'lastName','email', 'address', 'phoneNumber', 'gender', 'roleId']
    ...
    handleAddNewUser =()=>{
        ...
        if(isValid){
            ...
            this.props.createNewUser(this.state)//gọi function xử lý create user bên UserManage phần tử cha của ModalEditUser
    ...
    render() {
        ...
        return (
            <Modal isOpen={this.props.isOpen} toggle={() =>(this.toggle())} 
                ...
                <ModalHeader toggle={() =>(this.toggle())} className='custom-modal-header'>Edit a user
